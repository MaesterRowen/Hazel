...
Sandbox2D::Sandbox2D()
	: Hazel::Layer("Sandbox2D"), m_CameraController(16.0f / 9.0f, true)
{
...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
	...
	// Render Draw
	{
		...
		Hazel::Renderer2D::BeginScene(m_CameraController.GetCamera());
		{
			...
			Hazel::Renderer2D::DrawRotatedQuad({ -2.0f,  0.0f, 0.5f }, { 1.0f, 1.0f }, rotation, m_CheckerboardTexture, 20.0f);
		}
